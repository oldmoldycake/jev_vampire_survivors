...
<!-- MAINTAINER: this is the enforcement contact. It deliberately routes through GitHub instead of
     publishing a personal email address. If you later set up a dedicated conduct address (e.g.
     conduct@your-domain), replace the reporting routes in the paragraph below with that address —
